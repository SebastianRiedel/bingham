function F = bingham_F_2d_pos(z1,z2,iter)
% F = bingham_F_2d_pos(z1,z2,iter) - computes the normalization constant for the bingham
...
for i=0:iter-1
    for j=0:iter-1
         g = gammaln(i+1) + gammaln(j+1) - gammaln(i+j+3/2);
